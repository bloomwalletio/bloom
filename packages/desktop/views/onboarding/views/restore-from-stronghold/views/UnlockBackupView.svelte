...
<OnboardingLayout
    title={localize('views.onboarding.restoreFromStronghold.unlockBackup.title')}
    description={localize('views.onboarding.restoreFromStronghold.unlockBackup.description')}
    continueButton={{
