<script lang="ts">
    import { composeUrlFromNftUri, Nft, NFT_MEDIA_FILE_NAME } from '@core/nfts'
...
{#if hasMounted && nft && composeUrlFromNftUri(nft.mediaUrl) && nft.metadata && source && (!useCaching || nft.isLoaded)}
    <MediaDisplay
        src={source}
