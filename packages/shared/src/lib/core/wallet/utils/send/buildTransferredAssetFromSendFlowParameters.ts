...
import { SendFlowParameters, TokenSendFlowParameters, TokenTransferData } from '../../types'

export function buildTransferredAssetFromSendFlowParameters(
    sendFlowParameters: SendFlowParameters
): TransferredAsset | undefined {
    const { baseCoinTransfer, tokenTransfer } = sendFlowParameters as TokenSendFlowParameters
