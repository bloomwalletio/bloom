...
export const DEFAULT_CHAIN_CONFIGURATIONS: Readonly<{ [id in StardustNetworkId]?: ChainConfiguration[] }> = {
    ...
    [SupportedNetworkId.Testnet]: [
        ...
        {
            id: SupportedNetworkId.TestnetKycEvm,
            type: ChainType.Iscp,
            name: 'Testnet KYC EVM',
            chainId: EvmChainId.TestnetKycEvm,
            namespace: NetworkNamespace.Evm,
            coinType: DEFAULT_COIN_TYPE[SupportedNetworkId.TestnetKycEvm],
            aliasAddress: 'rms1pzhlaz2aalpsktkqacayyl2xr6s3rsa5h69lmc7mleq4wnaryejkgnprd6k',
            rpcEndpoint: 'https://fpgaonkrwz.dune.spyce5.com/wasp/api/',
            apiEndpoint: 'https://fpgaonkrwz.dune.spyce5.com/wasp/api/',
