...
import { SupportedEvmNetworkId, SupportedNetworkId } from './supported-network-id.constant'

export const DEFAULT_CHAIN_CONFIGURATIONS: Readonly<{ [id in StardustNetworkId]?: EvmNetworkConfiguration[] }> = {
    [SupportedNetworkId.Shimmer]: [
        {
            id: SupportedEvmNetworkId.ShimmerEvm,
            type: EvmNetworkType.Iscp,
            name: 'Shimmer EVM',
            chainId: ChainId.ShimmerEvm,
            namespace: NetworkNamespace.Evm,
            coinType: DEFAULT_COIN_TYPE[SupportedEvmNetworkId.ShimmerEvm],
    ...
    [SupportedNetworkId.Testnet]: [
        {
            id: SupportedEvmNetworkId.TestnetEvm,
            type: EvmNetworkType.Iscp,
            name: 'Testnet EVM',
            chainId: ChainId.TestnetEvm,
            namespace: NetworkNamespace.Evm,
            coinType: DEFAULT_COIN_TYPE[SupportedEvmNetworkId.TestnetEvm],
        ...
        {
            id: SupportedEvmNetworkId.TestnetKycEvm,
            type: EvmNetworkType.Iscp,
            name: 'Testnet KYC EVM',
            chainId: ChainId.TestnetKycEvm,
            namespace: NetworkNamespace.Evm,
            coinType: DEFAULT_COIN_TYPE[SupportedEvmNetworkId.TestnetKycEvm],
