...
import { IDownloadMetadata, IIrc27Nft, Nft } from '../interfaces'
...
): Partial<IDownloadMetadata> | undefined {
...
async function getNftDownloadData(nft: Nft): Promise<Partial<IDownloadMetadata>> {
