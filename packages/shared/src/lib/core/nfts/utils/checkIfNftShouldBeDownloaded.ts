...
import { IIrc27Nft, INft, NftDownloadMetadata } from '../interfaces'
...
function validateFile(nft: IIrc27Nft, contentType: string, contentLength: string): Partial<NftDownloadMetadata> {
