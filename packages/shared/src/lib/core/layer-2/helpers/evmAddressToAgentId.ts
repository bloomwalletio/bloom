...
export function evmAddressToAgentId(chainAliasAddress: string, evmStoreAccount: string): Uint8Array {
    ...
    const chainAliasAddressBinary = Converter.hexToBytes(evmStoreAccount?.toLowerCase())
